...
<head>
  ...
  <title><?php echo $title;?> &minus; berkarir</title>
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>adminlte/bower_components/datatables.net-bs/css/responsive.dataTables.min.css">
  <!-- Ionicons -->
